...
class PPOConfig(MethodConfig):
    ...
    :param bon_reward: true when bon should be used as reward
    :type bon_reward: Boolean
    """
    ...
    def loss(
        ...
        values: Float[Tensor, "batch_size response_size"],
        old_logprobs: Float[Tensor, "batch_size response_size"],
        old_values: Float[Tensor, "batch_size response_size"],
        advantages: Float[Tensor, "batch_size response_size"],
        returns: Float[Tensor, "batch_size response_size"],
        mask: Float[Tensor, "batch_size response_size"],
    ):
